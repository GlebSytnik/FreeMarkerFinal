...
public class GenerateNew {
    ...
    public GenerateNew() throws IOException {
    ...
    public void generateJavaSourceFiles(Collection<MetaDataInfoTableForGenerateModel> dataInfoTables, File fileDirectory) throws Exception {
        Map<String, Object> freemarkerDataModel = new HashMap<>();
        Template template = configuration.getTemplate("genNewModel.ftl");
        for (MetaDataInfoTableForGenerateModel metaDataInfoTable : dataInfoTables) {
